...
Menu.prototype = {
  ...
  create: function() {
    var style = { font: '65px Arial', fill: '#ffffff', align: 'center'};
    this.sprite = this.game.add.sprite(this.game.world.centerX, 138, 'avatar0');
    this.sprite.anchor.setTo(0.5, 0.5);

    this.titleText = this.game.add.text(this.game.world.centerX, 300, '\'Allo, \'Allo!', style);
    this.titleText.anchor.setTo(0.5, 0.5);

    this.instructionsText = this.game.add.text(this.game.world.centerX, 400, 'Click anywhere to play "Click The Carrot Top"', { font: '16px Arial', fill: '#ffffff', align: 'center'});
...
},{"../elements/NetManager.js":1,"underscore":8}],7:[function(require,module,exports){
'use strict';
function Preload() {
  this.asset = null;
  this.ready = false;
...
Preload.prototype = {
  preload: function() {
    ...
    this.load.image('avatar0', 'assets/avatar0.png');
